...
export const CDeleteDialog = (props: ICDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myApp.jhipsterSampleApplicationC.delete.question">
        <Translate contentKey="myApp.jhipsterSampleApplicationC.delete.question" interpolate={{ id: cEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-c" color="danger" onClick={confirmDelete}>
