...
import { getEntities as getAs } from 'app/entities/jhipsterSampleApplication/a/a.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.jhipsterSampleApplicationB.home.createOrEditLabel">
            <Translate contentKey="myApp.jhipsterSampleApplicationB.home.createOrEditLabel">Create or edit a B</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
